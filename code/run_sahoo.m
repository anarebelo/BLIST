function run_sahoo(directory)

% create output dir
filedir=strcat(directory, '/images/binarizations/sahoo/');
...
threshfile = strcat(directory, '/results/global_thresholds/sahoo.txt');
