function ME_adotsu(directory)

% directory of grey scale images
dt = strcat(directory, '/images/binarizations/adotsu');
d=dir(dt);
d=struct2cell(d);
names=d(1,3:end,:);
...
%initiate file ids
fileME = strcat(directory, '/results/ME/adotsu.txt');
fileMOPx = strcat(directory, '/results/MOPx/adotsu.txt');
fileFOPx = strcat(directory, '/results/FOPx/adotsu.txt');
