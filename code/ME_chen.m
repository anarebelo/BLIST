function ME_chen(directory)

% directory of grey scale images
dt = strcat(directory, '/images/binarizations/chen');
d=dir(dt);
d=struct2cell(d);
names=d(1,3:end,:);
...
%initiate file ids
fileME = strcat(directory, '/results/ME/chen.txt');
fileMOPx = strcat(directory, '/results/MOPx/chen.txt');
fileFOPx = strcat(directory, '/results/FOPx/chen.txt');
