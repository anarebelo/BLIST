function run_tsallis(directory)

% create output dir
filedir=strcat(directory, '/images/binarizations/tsallis/');
...
threshfile = strcat(directory, '/results/global_thresholds/tsallis.txt');
