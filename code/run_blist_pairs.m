function run_blist_pairs(directory)

% create output dir
filedir=strcat(directory, '/images/binarizations/blist_pairs/');
...
threshfile = strcat(directory, '/results/global_thresholds/blist_pairs.txt');
