function ME_yanowitz(directory)

% directory of grey scale images
dt = strcat(directory, '/images/binarizations/yanowitz');
d=dir(dt);
d=struct2cell(d);
names=d(1,3:end,:);
...
%initiate file ids
fileME = strcat(directory, '/results/ME/yanowitz.txt');
fileMOPx = strcat(directory, '/results/MOPx/yanowitz.txt');
fileFOPx = strcat(directory, '/results/FOPx/yanowitz.txt');
