function ME_bernsen(directory)

% directory of grey scale images
dt = strcat(directory, '/images/binarizations/bernsen');
d=dir(dt);
d=struct2cell(d);
names=d(1,3:end,:);
...
%initiate file ids
fileME = strcat(directory, '/results/ME/bernsen.txt');
fileMOPx = strcat(directory, '/results/MOPx/bernsen.txt');
fileFOPx = strcat(directory, '/results/FOPx/bernsen.txt');
