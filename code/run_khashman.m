function run_khashman(directory)

% create output dir
filedir=strcat(directory, '/images/binarizations/khashman/');
...
threshfile = strcat(directory, '/results/global_thresholds/khashman.txt');
