function ME_adblist(directory)

% directory of grey scale images
dt = strcat(directory, '/images/binarizations/adblist');
d=dir(dt);
d=struct2cell(d);
names=d(1,3:end,:);
...
%initiate file ids
fileME = strcat(directory, '/results/ME/adblist.txt');
fileMOPx = strcat(directory, '/results/MOPx/adblist.txt');
fileFOPx = strcat(directory, '/results/FOPx/adblist.txt');
